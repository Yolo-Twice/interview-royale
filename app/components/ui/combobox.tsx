...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl border border-transparent py-2 pr-8 pl-3 text-sm font-medium outline-hidden select-none data-highlighted:border-transparent data-highlighted:bg-accent data-highlighted:text-accent-foreground data-selected:border-transparent data-selected:ring-0 not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
